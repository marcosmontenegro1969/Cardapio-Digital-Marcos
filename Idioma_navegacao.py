...
mensagens = {
    'pt': {
        ...
        'cadastro_de_cliente': "3 - Cadastro de cliente",
        'manutencao_cadastro_cliente': "\nManutenção de Cadastro de Cliente",
        'fazer_cadastro_cliente': "\n1 - Fazer cadastro",
        'consultar_cadastro_cliente': "2 - Consultar cadastro",
        'cadastro_nao_encontrado': "Cadastro não Encontrado",
        'nenhum_cliente_cadastrado': "Nenhum Cliente Cadastrado",
        'consulta_cadastro_cliente': "\nConsulta de Cadastro de Cliente\n",
        'informe_email_para_consulta': "\nInforme o email para consultar o cadastro.",
        'alterar_cadastro_cliente': "3 - Alterar cadastro",
        'excluir_cadastro_cliente': "4 - Excluir cadastro",
        'inclusão_cadastro_cliente': "\nInclusão de cadastro de cliente.",
        'informe_email': "Informe seu email: ",
        'email_invalido': "\nEmail inválido.",
        ...
        'alterar_cadastro_cliente': '3 - Alterar Cadastro de Cliente',
        'alteracao_cadastro_cliente': 'Alterar Cadastro de Cliente',
